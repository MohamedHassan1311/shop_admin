...
class _EditAdmin extends State<EditAdmin> {
  ...
  Widget build(BuildContext context) {
    ...
    print(product.PAvlibelSize);
    CartItem cartitems = Provider.of<CartItem>(context, listen: false);
    var _store = Store();
    var size = ["L", "xL", "m", "size"];
    print("sssssssssssssssskkkkkkkkkkkkkkkkk ${product.PAvlibelSize}");
    ...
    List<NetworkImage> imges = [
      NetworkImage(product.Ploction),
    ];
    if (product.Ploction2 != null) {
      imges.add(NetworkImage(product.Ploction2));
    }
    if (product.Ploction3 != null) {
      imges.add(NetworkImage(product.Ploction3));
    }
    setState(() {
      product.Pname;
    });
...
//                      itemCount: product.PAvlibelSize.length,
//                    )
////                  Row(
////                    children: <Widget>[
////                      Expanded(
