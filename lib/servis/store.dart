...
class Store {
  ...
  addProudect({Product product, ProductColiction}) async {
    await _firestore.collection(ProductColiction).add({
      KProudectAvSize: product.PAvlibelSize,
      KProudectCatogery: product.Pcatogery,
      KProudectLoction: product.Ploction,
      KProudectLoction2: product.Ploction2,
      KProudectLoction3: product.Ploction3,
